;<div className="outBox">
  ...
  <div>
    ...
    <div aria-label="모집인원수" className="expected_personnel"></div>
    <div aria-label="마감일" className="due_date"></div>
  ...
  <div>
    <div aria-label="조회수" className="viewCount"></div>
    <div aria-label="북마크" className="bookmarkCount"></div>
  </div>
</div>
