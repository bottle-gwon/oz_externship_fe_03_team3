...
const normalConfig = { ...baseConfig, rules: normalRules }
const strictConfig = {
  ...baseConfig,
  rules: { ...normalRules, ...strictRules },
}

export const normalConfigArray = [...commonConfigArray, normalConfig]
export const strictConfigArray = [...commonConfigArray, strictConfig]
